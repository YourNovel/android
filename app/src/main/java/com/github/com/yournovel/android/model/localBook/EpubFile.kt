...
import com.github.com.yournovel.android.utils.encodeURI
...
class EpubFile(var book: Book) {
    ...
    companion object : BaseLocalBookParse {
        ...
        private fun getEFile(book: Book): EpubFile {
            if (eFile == null || eFile?.book?.bookUrl != book.bookUrl) {
                eFile = EpubFile(book)
                //对于Epub文件默认不启用替换
                //com.github.com.yournovel.android.data.entities.Book getUseReplaceRule
                return eFile!!
            }
            eFile?.book = book
            return eFile!!
    ...
    private fun parseFirstPage(
        ...
        while (i < contents.size) {
             ...
             * fix https://github.com/YourNovel/android/issues/1932
             */
