...
```
* jsLib
> 注入JavaScript到RhinoJs引擎中，支持两种格式，可实现[函数共用](https://github.com/YourNovel/android/wiki/JavaScript%E5%87%BD%E6%95%B0%E5%85%B1%E7%94%A8)
...
> 部分变量说明：java（仅支持[js扩展类](https://github.com/YourNovel/android/blob/master/app/src/main/java/io/legado/app/help/JsExtensions.kt)），result为待解密图片的`ByteArray`，src为图片链接
